<x-layout>
    <div class="container">
        <h1 class="text-center my-5">Edit Printer</h1>
                ...
                <form method="POST" action="{{ route('printers.update', $printer->id) }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control @error('model') is-invalid @enderror" id="model"
                            name="model" value="{{ old('model') ?? $printer->model }}"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control @error('manufacturer') is-invalid @enderror"
                            ...
                            value="{{ old('manufacturer') ?? $printer->manufacturer }}"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control @error('max_print_size') is-invalid @enderror"
                            id="max_print_size" name="max_print_size"
                            value="{{ old('max_print_size') ?? $printer->max_print_size }}"
                    ...
                    <div class="text-center">
                        <button type="submit" class="btn btn-success btn-lg">Update Printer</button>
                    </div>
                </form>
            </div>
        </div>
